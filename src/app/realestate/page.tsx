        ...
        <div className="max-w-2xl mx-auto">
          ...
          {formSubmitted ? (
            <div className="bg-white rounded-2xl p-8 text-center">
              ...
              <p className="text-gray-600 mb-6">Now chat with our AI assistant on WhatsApp to see it in action and book your discovery call.</p>
              <a
                href={`https://wa.me/14099083940?text=${encodeURIComponent(`Hi, I just booked a discovery call. My name is ${formData.name}${formData.agency ? ` from ${formData.agency}` : ''}. I'd like to see how the AI assistant works for my business.`)}`}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 bg-green-500 text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-green-600 transition-colors"
              >
              ...
              <p className="text-gray-500 mt-4 text-sm">Our AI will qualify your needs and schedule your discovery call instantly.</p>
            </div>
          ) : (
